...
{
    [ExportService(typeof(IYellowGreen))] 
    [Export(typeof(IYellowGreen))]
    public class Service_YellowGreen : ServiceBase, IYellowGreen
    {
