...
{
    [ExportService(typeof(IMelonYellow))] 
    [Export(typeof(IMelonYellow))]
    public class Service_MelonYellow : ServiceBase, IMelonYellow
    {
