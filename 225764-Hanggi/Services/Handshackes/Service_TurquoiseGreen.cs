...
{
    [ExportService(typeof(ITurquoiseGreen))] 
    [Export(typeof(ITurquoiseGreen))]
    public class Service_TurquoiseGreen : ServiceBase, ITurquoiseGreen
    {
